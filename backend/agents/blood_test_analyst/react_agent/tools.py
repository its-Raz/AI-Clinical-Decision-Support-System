...
def check_reference_range(
    ...
    Args:
        test_name: Name of lab test_images (e.g., "Hemoglobin", "Glucose", "Creatinine")
    ...
    """
    # Get reference range for this test_images
...
def get_reference_range(test_name: str, sex: str, age: int = None):
    """
    Get reference range for a specific test_images.

    Args:
        test_name: Name of the lab test_images
...
def classify_value(value: float, ref_range: dict, test_name: str = None) -> dict:
    ...
    Args:
        value: The test_images result value
        ref_range: Reference range dictionary
        test_name: Optional test_images name for special handling
