...
# Perfect test_images case for anomaly detection algorithms
...
MOCK_PATIENTS = {
    ...
    "P003": {
        ...
        "recent_notes": [
            ...
            "2025-11-08: Patient presented to urgent care with influenza-like illness: high fever (102.8°F), body aches, cough, fatigue. Rapid flu test_images positive for Influenza A. Prescribed oseltamivir.",
