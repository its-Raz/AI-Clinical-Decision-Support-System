...
class ReActAgent:
    ...
    def __init__(self, config_path: str = None):
        ...
        Args:
            config_path: Path to config.yaml (optional, defaults to analyst/config.yaml)
        """
        # Load config from analyst folder (parent directory)
        if config_path is None:
            # Go up one level from react_agent to analyst folder
